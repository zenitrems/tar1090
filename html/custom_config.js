...
actual_range_outline_width = 1.5;
// NOTE: dashed lines cause slowdown when zooming in, not recommended
...
webglIconOpacity = 0.85;
webglIconMapMoveOpacity = 0.70;
...
ColorByAlt = {
        ...
        unknown : { h: 120,   s: 5,   l: 40 },

        // HSL for planes that are on the ground:
        ground  : { h: 60, s: 15, l: 35 },
...
//
MapboxAPIKey = "pk.eyJ1IjoiemVubGFiIiwiYSI6ImNtaWNxbDczbjBmb2wyam9sbnQ1bThjdTUifQ.4N0PcI36mkqd1iuOPETkZQ";

// Provide an OpenAIP.net API key here to enable the OpenAIP layer.
OpenAIPKey = "6d086ada56d93e98d77371dd78afea93";
...
//
//filterMaxRange = 350; // don't show aircraft further than 50 nmi from the receiver
//
//
...
jaeroLabel = "HFDL"; // relabel the ADS-C data if used for other purposes (i.e. HFDL / acars2pos)

seenTimeout = 60; // in seconds
seenTimeoutMlat = 180; // in seconds
...
//prefer978 = 0;
//
dynGlobeRate = true; // enable use of globeRates.json in index.html directory to steer client refresh rate
...
DefaultCenterLat = 21.0;
DefaultCenterLon = -87.3;
//
